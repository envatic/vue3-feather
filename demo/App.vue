<template>
  <div id="app">
    <github
      v-tippy="{ title: 'Star me on GitHub', trigger: 'click' }"
      fill="white"
      slug="envatic/vue3-feather"
    >
    </github>
    <header class="header">
      <div class="container">
        <h1 class="hero-heading">vue3-feather</h1>
        <h2 class="desc">
    ...
    <div class="container">
      ...
      <div class="icons">
        <div
          class="icon"
          v-tippy="{ interactive: true, delay: [100, 0] }"
          :content="example"
          v-for="icon in filteredIcons"
          @mouseover="handleClickIcon(icon)"
          :key="icon"
        >
